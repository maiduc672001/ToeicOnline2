...
<div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <form action="${editUserUrl}" method="post" id="editUserForm">
                    ...
                    <div class="col-md-12">
                        <div class="md-form">
                            <input type="text" placeholder="<fmt:message key='label.user.name' bundle='${lang}'/>"
                                   class="form-control" value="${item.pojo.name}" id="username" name="name"
                                   required/>
                        </div>
                    </div>
                    <br/>
                    ...
                    <div class="col-md-12">
                        <div class="md-form">
                            <input type="text" placeholder="<fmt:message key='label.user.fullName' bundle='${lang}'/>"
                                   class="form-control" value="${item.pojo.fullName}" name="fullName"/>
                        </div>
                    </div>
                    <br/>
                    <br/>
                    ...
                    <div class="col-md-12">
                        <div class="md-form">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <select id="role" name="roleId">
                                        <option value="-1"><fmt:message bundle='${lang}'
                                                                        key='label.option.role'/></option>
                                        <c:forEach items="${item.roles}" var="itemRole">
                                            <option value="${itemRole.roleId}">${itemRole.name}</option>
                                        </c:forEach>
                                    </select>
            ...
            <input type="hidden" name="urlType" value="edit"/>--%>
        </form>
